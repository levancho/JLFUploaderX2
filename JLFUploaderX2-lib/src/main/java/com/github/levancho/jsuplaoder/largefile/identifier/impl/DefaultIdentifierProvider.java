package com.github.levancho.jsuplaoder.largefile.identifier.impl;
...
public class DefaultIdentifierProvider
	...
	UUID getUuid() {
		...
		uploadxListenerPropagator.getPropagator().onNewClient(uuid);
		return uuid;
	}
	...
	public UUID getIdentifier(HttpServletRequest req, HttpServletResponse resp) {
		...
		if (uuid == null) {
			...
			if (cookie != null && cookie.getValue() != null) {
				...
				uploadxListenerPropagator.getPropagator().onClientBack(uuid);
				return uuid;
			}
