...
import com.github.levancho.jsuplaoder.largefile.exception.AuthorizationException;
...
import com.github.levancho.jsuplaoder.largefile.logic.UploadProcessor;
...
@WebServlet(name = "javaLargeFileUploaderServlet", urlPatterns = { "/uploaderx2/javaLargeFileUploaderServlet" })
