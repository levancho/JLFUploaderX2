...
import com.github.levancho.jsuplaoder.largefile.staticstate.FileDeleter;
import com.github.levancho.jsuplaoder.largefile.staticstate.StaticStateRootFolderProvider;
...
public class ImportedFilesCleaner {
	...
	private static Log log = LogFactory.getLog(ImportedFilesCleaner.class);
	...
	@Value("upx2{uploader.filecleaner.maximumInactivityInHoursBeforeDelete:48}")
