 ...
 * {@link com.github.levancho.jsuplaoder.largefile.notifier.JLFUListener}s.<br>
...
public class ProgressManager {
	...
	class ProgressManagerAdvertiser {
		...
		void advertise(UUID clientId, UUID fileId, FileProgressStatus newProgress) {
			uploadxListenerPropagator.getPropagator().onFileUploadProgress(clientId, fileId, newProgress);
		}
	}
