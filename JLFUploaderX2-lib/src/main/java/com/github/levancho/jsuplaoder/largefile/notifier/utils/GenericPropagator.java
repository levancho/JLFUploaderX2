package com.github.levancho.jsuplaoder.largefile.notifier.utils;
...
import com.github.levancho.jsuplaoder.largefile.notifier.JLFUListener;
...
public abstract class GenericPropagator<T> {
	...
	private static Log log = LogFactory.getLog(GenericPropagator.class);
