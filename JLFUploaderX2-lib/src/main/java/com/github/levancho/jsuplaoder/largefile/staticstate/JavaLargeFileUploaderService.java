...
public class JavaLargeFileUploaderService<T extends StaticStatePersistedOnFileSystemEntity> {
	...
	private static Log log = LogFactory.getLog(JavaLargeFileUploaderService.class);
	...
	public void enableFileUploader() {
		...
		uploadxListenerPropagator.getPropagator().onFileUploaderEnabled();
	}
	...
	public void disableFileUploader() {
		...
		uploadxListenerPropagator.getPropagator().onFileUploaderDisabled();
	}
